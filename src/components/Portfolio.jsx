...
const projects = [
  ...
  {
    title: "SolMate",
    image: "/web-wallet.png",
    tags: ["Web3", "solana", "blockchain"],
    description: "Soulmate is a sleek Solana DevNet wallet tool that lets you check your SOL balance, request airdrops, send tokens to any wallet, and securely sign messages — all in one simple interface.",
    link: "https://solmate25519.vercel.app",
    techStack: [
      "React",
      "Web3.js",
      "Tailwindcss",
    ],
    github: "https://github.com/chauhan-varun/web-wallet",
  },
  {
