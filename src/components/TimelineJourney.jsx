...
const journeyEvents = [
  {
    ...
    description: 'Began learning web development with HTML, CSS, and JavaScript in class 12th',
    icon: '🚀',
    color: 'bg-blue-500',
  },
  {
  ...
  },
  {
    year: '2025 February',
    title: 'Blockchain',
    description: 'Started learning Blockchain development with Ethereum and Solidity.',
    icon: '🧱',
    color: 'bg-pink-500',
  },
  {
    year: '2025 April',
    title: 'Learning Smart Contracts',
    description: 'Diving into the world of blockchain development with Ethereum and Solidity.',
    icon: '⛓️',
    color: 'bg-amber-500',
  },
];
