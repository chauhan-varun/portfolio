...
function TechItem({ tech, position, speed = 1, showTooltips = true }) {
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Enhanced Tooltip with prominent name and description */}
            {showTooltips && (
              <Tooltip id={tooltipId} className="z-50 max-w-xs">
                <div className="p-2">
                  <div className="mb-1 text-base font-bold">{tech.name}</div>
...
function Scene({ technologies, showTooltips }) {
  return (
    <group>
...
export default function ThreeJSCloud({ technologies, showTooltips = true }) {
  return (
    <div className="relative h-[400px] md:h-[550px] w-full">
      ...
      >
        ...
        <Scene technologies={technologies} showTooltips={showTooltips} />
      </Canvas>
